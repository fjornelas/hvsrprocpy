...
__all__ = ['_add_mseed_tool', 'proc_mseed_data', 'proc_txt_data', 'process_time_series']


def _add_mseed_tool(st):
    """
...
def proc_mseed_data(file_direc, h1_fn, h2_fn, v_fn, trim_flag=False, time_cut=300):
    ...
    file_direc: string
        Specifies where the files are stored.
    h1_fn: string
        Specifies the name of the file for the h1 component.
    h2_fn: string
        Specifies the name of the file for the h2 component.
    v_fn: string
        Specifies the name of the file for the v component.
    trim_flag: boolean
        Specifies whether to trim the trace. Default = False.
    time_cut: int
        Specifies how much time cut in seconds. Default = 300

    returns an array of each component.
    ...
    if trim_flag:
        h1 = _add_mseed_tool(h1)
        h2 = _add_mseed_tool(h2)
        v = _add_mseed_tool(v)
